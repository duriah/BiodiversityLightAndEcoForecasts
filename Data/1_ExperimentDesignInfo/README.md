...
- `Compositions.csv`: contains the information about which species made up the 15 different communities
- `ExperimentalDesign.csv`: contains the experimental design (bottles, compositions, treatments, incubators)
